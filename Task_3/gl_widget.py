...
class glWidget(QtWidgets.QOpenGLWidget, ui_for_particles.Ui_MainWindow):
    ...
    def add_and_visualise_particle(self):
        ...
        if (len(self.list_of_particles) != 0):
            print('Проверка в glWidget!!!', self.list_of_particles[0].color, self.list_of_particles[0].m,
                  self.list_of_particles[0].x, self.list_of_particles[0].y, self.list_of_particles[0].z,
                  self.list_of_particles[0].xv, self.list_of_particles[0].yv, self.list_of_particles[0].zv)
    ...
    def visualisation_particle(self):
        ...
        if len(self.list_of_solar_system) == 9:
            for k in range(len(self.list_of_solar_system)):
                ...
                gl.glTranslatef(self.list_of_solar_system[k].x * 7, self.list_of_solar_system[k].y * 7,
            ...
            for k in range(len(self.list_of_particles)):
                ...
                gl.glTranslatef(-self.list_of_particles[k].x, -self.list_of_particles[k].y,
